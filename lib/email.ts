...
export async function sendClientEmail(
  ...
  const tierColor = TIER_COLOR[score.tier] ?? '#001D3D';
...
<body style="margin:0;padding:0;background:#f9fafb;font-family:Inter,system-ui,sans-serif;">
  <div style="max-width:600px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
    ...
    <!-- Header bar -->
    <div style="background:#001D3D;padding:28px 32px;">
      <div style="font-size:12px;text-transform:uppercase;letter-spacing:2px;color:#FCBA12;margin-bottom:4px;">AlphaCreative</div>
    ...
    <div style="padding:32px;">
      ...
      <!-- Score callout -->
      <div style="background:#fffdf0;border:2px solid #FCBA12;border-radius:10px;padding:24px;text-align:center;margin-bottom:24px;">
        ...
        <div style="font-size:56px;font-weight:800;color:#001D3D;line-height:1;">${score.total}</div>
      ...
      <div style="text-align:center;margin-bottom:24px;">
        <a href="https://alphacreative.as.me/"
          style="display:inline-block;background:#FCBA12;color:#001D3D;font-size:15px;font-weight:700;padding:14px 28px;border-radius:8px;text-decoration:none;margin-bottom:12px;">
          Book Your Strategy Call →
        </a>
        <br/>
        <a href="${reportUrl}"
          style="font-size:13px;color:#001D3D;text-decoration:none;">
      ...
      <p style="font-size:13px;color:#9ca3af;border-top:1px solid #f3f4f6;padding-top:16px;">
        ...
        Questions? Reply to this email or visit <a href="https://thealphacreative.com" style="color:#FCBA12;">thealphacreative.com</a>
      </p>
    </div>
  </div>
</body>
  ...
  <div style="max-width:600px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
    ...
    <div style="padding:28px;">
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:20px;font-size:14px;">
        ...
        <tr><td style="padding:6px 0;color:#6b7280;">Email</td><td style="padding:6px 0;"><a href="mailto:${submission.email}" style="color:#001D3D;">${submission.email}</a></td></tr>
      ...
      <!-- Score summary -->
      <div style="background:#fffdf0;border-left:4px solid #FCBA12;padding:16px 20px;border-radius:0 8px 8px 0;margin-bottom:20px;">
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <div>
            <div style="font-size:12px;color:#6b7280;text-transform:uppercase;letter-spacing:1px;">Growth Score</div>
            <div style="font-size:32px;font-weight:800;color:#001D3D;">${score.total}<span style="font-size:14px;color:#6b7280;">/100</span></div>
          </div>
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:20px;">
        <a href="${reportUrl}"
          style="background:#FCBA12;color:#001D3D;padding:10px 18px;border-radius:6px;font-size:13px;font-weight:600;text-decoration:none;">
          View Report
        </a>
